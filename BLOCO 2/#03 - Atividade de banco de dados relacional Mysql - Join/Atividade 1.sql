...
values ('ash',2000,1500,3);

insert into tb_personagens (nome,cidade,ataque,defesa,id_classe) 
values ('xena','atenas',1000,1900,5);

insert into tb_personagens (nome,cidade,ataque,defesa,id_classe) 
values ('thor','argasd',500,1);

insert into tb_personagens (nome,cidade,ataque,defesa,id_classe) 
values ('chapolin','mexico',1200,3000,2);

insert into tb_personagens (nome,cidade,ataque,defesa,id_classe) 
values ('lindinha','Townsville',2000,4500,3);
