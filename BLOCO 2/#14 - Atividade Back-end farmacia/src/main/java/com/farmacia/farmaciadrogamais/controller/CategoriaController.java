...
public class CategoriaController {
	...
	@GetMapping public ResponseEntity<Categoria> getAll(){
	...
	@GetMapping("pesquisa/{categoriaMedicamento}")
	public ResponseEntity<List<Categoria>> getByTitle(@PathVariable String medicamento){
		return ResponseEntity.ok(categoriaRepository
				.findAllByMedicamentoContainingIgnoreCase(medicamento));}
